`upload.js` se encarga de todo lo relacionado con archivos: drag & drop, lectura y extracción de la cabecera.
...
// RFC 2822: las cabeceras terminan en la primera línea en blanco
...
/* ── Inicialización de eventos de upload ── */
function initUpload() {
  ...
  // Evita que el clic en "selecciona uno" dispare dos veces
...
Cópialo en `frontend/js/upload.js`. Seguimos con `main.js`, que es el último y conecta todo.